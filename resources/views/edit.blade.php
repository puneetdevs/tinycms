						...
						<div class="col-lg-12">
							<section class="panel">
								...
								<div class="panel-body">
									<form class="form-horizontal form-bordered" method="post" action="/update/{{ $page->id }}"">
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="short_desc">Short Desc</label>
											<div class="col-md-6">
												<!--<input type="text" class="form-control" id="short_desc" name="short_desc" value="{{$page->short_desc}}">-->
												<textarea rows="4" cols="50" class="form-control body_text" name="short_desc" id="short_desc">{{$page->short_desc}}</textarea>
											</div>
										</div>
										
										<div class="form-group">
											<label class="col-md-3 control-label" for="details">Body</label>
											<div class="col-md-6">
												<!--<input type="text" class="form-control" id="details" name="details" value="{{$page->details}}">-->
												<textarea rows="4" cols="50" class="form-control body_text" name="details" id="details">{{$page->details}}</textarea>
											</div>
										</div>
					
										<div class="form-group">
											<label class="col-md-3 control-label" for="parent_id">Parent Page</label>
											<div class="col-md-6">
												<select class="form-control mb-md" name="parent_id" id="parent_id" value="{{$page->parent_id}}">
													<option>Please Select</option>
													@foreach($pages as $page)
													<option value="{{ $page->id }}" name="selected_parent">{{ $page->title }}</option>
													@endforeach
												</select>
											</div>
										</div>
