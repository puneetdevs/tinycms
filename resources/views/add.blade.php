						...
						<div class="col-lg-12">
							<section class="panel">
								...
								<div class="panel-body">
									<form class="form-horizontal form-bordered" method="post" action="{{ url('/store') }}">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												...
												<textarea rows="4" cols="50" class="form-control" name="short_desc" id="short_desc"> </textarea>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												...
												<textarea rows="4" cols="50" class="form-control body_text" name="details" id="details"> </textarea>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<select class="form-control mb-md" name="parent_id" id="parent_id">
